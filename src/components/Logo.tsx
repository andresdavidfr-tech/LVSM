    ...
    return (
      <div className={`flex items-center gap-3 ${className}`}>
        ...
        <div className="flex flex-col leading-none">
          ...
          <span className="text-xs uppercase tracking-[0.3em] opacity-50">The Collective</span>
        </div>
      </div>
    );
  }
  ...
  if (variant === 'collective') {
    return (
      <div className={`flex items-center gap-3 ${className}`}>
        ...
        <div className="flex flex-col leading-none">
          <span className="text-xl font-serif tracking-[0.2em] uppercase">LVSM</span>
          <span className="text-xs uppercase tracking-[0.3em] opacity-50">Select Club</span>
        </div>
      </div>
    );
  }
