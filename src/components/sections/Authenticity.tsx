...
const steps = [
  ...
  { title: 'Convalidada con Expertos', desc: 'Consultamos con especialistas de cada marca ante cualquier duda sobre una pieza.' },
...
export function Authenticity() {
  return (
    <section id="authenticity" className="py-24 bg-brand-paper scroll-mt-24">
